...
@if (session('status'))
    ...
    border-top: solid;opacity:0.8">
        ...
        @endif
<body style="background: -webkit-linear-gradient(left, brown, white);" onload="resetSelection()">

<div class="container register" style="border-radius: 200px 297px 297px 200px;border-top-left-radius: 10% 50%;
border-bottom-left-radius: 10% 50%;">
                <div class="row">
                
                    <div class="col-md-3 register-left"style="background=:indianred">
                    <br><br><br><br><br><br><br>
                        <br><br><br><br><br>
                        <h3>Welcome</h3>
                        <p>“Spare only 2 minutes and save one life”</p>
                        
                    
                    </div>
                    <div class="col-md-9 register-right"style="border-radius: 0px 300px 300px 0px;
                    border-top-left-radius: 10% 50%;border-bottom-left-radius: 10% 50%;">
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                <h3><b><div id="error" style="color : red ;margin-top:20px; margin-left:14rem; display:none;"></b></h3></div>                               
                                <h3 id="heading" class="register-heading" style="color:indianred;"><b style="border-bottom:5px solid">Need Plasma</b></h3>
                                <form class="form" action="/thankyou" method="post" enctype="multipart/form-data">
                                    @csrf
                                ...
                                <div class="row register-form" >
                                    <div class="col-md-6">
                                        ...
                                        <select id ="state" class="form-control" required placeholder="City *" name="city"></select>
                                           
                                        </div>
                                        <div class="form-group">
                                        <label>Hospital Name</label>
                                            <input type="text" class="form-control"  placeholder="Hospital Name*" id="city" name="hospital" required>
                                        </div>
                                        <label> Gender</label>
                                        <select name="opt_gender" id="state" class="form-control" required>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <label>Attendant Number </label>
                                            ...
                                            <input type="text" maxlength="10"  class="form-control" placeholder="Phone Number *" name="phone" required>
                                        </div>
                                        <div class="form-group">
                                        <label>Attendant Ward Number/Name</label>
                                            <input type="text"class="form-control" placeholder="Attendant Ward Number/Name *" name="ward"  required>
                                        </div>
                                        <label> Blood Group</label>
                                        <select name="opt_group" id="state" class="form-control" required>
                                        ...
                                        <select name="opt_plasma" id="state" class="form-control" required>
                                        <option value="Select What You Want ">Select What You Want</option>
                                        <option value="Plasma">Plasma</option>
                                        <option value="Blood">Blood</option>   
                                        <option value="Both">Both</option>
                                        </select><br><br>
                                        <button name="submit" type="submit" class="btn btn-primary btn-block" style="background:indianred;border-radius: 80px 10px 80px 10px;">Apply</button><br>
                                    </div>
                                </div>
                            </div> 
                        </form>
